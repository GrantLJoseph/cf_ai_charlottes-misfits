...
A placement is 1 or more cards. Cards of the same rank can be placed together. A straight of three or more cards can be placed together. Straights and multiple of a kind cannot be combined in the same placement.
...
The top of the stack is a 7. The player can play 3 10s.
